...
convert_cell_to_tile_along_i_axis(i::Integer, cells_per_tile_length::Integer) = (i - one(i)) ÷ cells_per_tile_length + one(i)
...
function cast_ray(obstacle_tile_map::AbstractArray{Bool, 2}, i_ray_start_cell, j_ray_start_cell, i_ray_direction, j_ray_direction, cells_per_tile_length, max_steps)
    ...
    i_ray_start_tile = convert_cell_to_tile_along_i_axis(i_ray_start_cell, cells_per_tile_length)
    j_ray_start_tile = convert_cell_to_tile_along_i_axis(j_ray_start_cell, cells_per_tile_length)
