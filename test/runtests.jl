...
Test.@testset "RayCaster.jl" begin
    ...
    Test.@testset "Discrete world" begin
        ...
        Test.@testset "delta_i = 1, delta_j = 0" begin
            ...
            i_ray_start_tile, j_ray_start_tile, i_stop_tile_units, j_stop_tile_units, hit_dimension, delta_i_world_units_to_exit_start_tile, delta_j_world_units_to_exit_start_tile = RC.cast_ray(obstacle_tile_map, i_ray_start_cell, j_ray_start_cell, i_ray_direction, j_ray_direction, world_units_per_tile_unit)
